...
import { IonContent, IonIcon, IonSelect, IonSelectOption, ModalController } from '@ionic/angular'; // ≡ƒÜ¿ Swapped to ModalController
...
// ≡ƒÜ¿ Import your new custom modal! (Adjust path if needed based on your folder structure)
...
export class ManageUsersPage implements OnInit, OnDestroy  {
  ...
  private modalCtrl = inject(ModalController); // ≡ƒÜ¿ Injected ModalController
  ...
  // ≡ƒÜ¿ Open Blue Custom Modal for Creating
  async addUser() {
    this.errorMessage = ''; 
    this.successMessage = ''; 
  ...
  // ≡ƒÜ¿ Open Red Custom Modal for Deleting
